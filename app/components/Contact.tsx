                ...
                <div className='w-full px-10 flex'>
                    ...
                    <div className='md:w-1/2 w-full px-3 mt-24'>
                        <form className="flex flex-wrap justify-between">
                            ...
                            <input className="border bg-stone-100 px-5 py-3 text-sm mt-8 outline-none flex items-start placeholder:font-light w-full min-h-64" type="text" placeholder="Your Message*" />
                        </form>
                    </div>
                </div>
            </section>
