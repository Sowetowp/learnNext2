    ...
    return (
        <>
            <section id='sec5' className='w-full max-w-7xl m-auto bg-white py-28'>
                <h2 data-aos="fade" data-aos-duration="1000" className='font-bold text-[1.6rem] text-center m-auto max-w-[80%]'>Our expert consultants</h2>
                ...
                <div className='w-full md:px-10 flex flex-wrap'>
                    {exp.map((ex, index) => (
                        <div key={index} className='xl:w-1/4 md:w-1/2 w-full text-center mt-14 px-3'>
                            ...
                            <p data-aos="fade" data-aos-duration="1000" className='font-medium text-xs tracking-wider mt-5 text-center'>{ex.name}</p>
                            <p data-aos="fade" data-aos-duration="1000" className='text-[0.8rem] mt-1 text-gray-500'>{ex.post}</p>
                        </div>
                    ))}
                </div>
            </section>
