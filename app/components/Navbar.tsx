...
const Navbar = () => {
    ...
    return (
        <>
            <header className={`w-full ${scrollHeader ? "fixed z-[9999]" : "relative z-[9999]"} ${menu? "bg-[#000000f3]":""}`}>
                ...
                <section className={`w-full m-auto max-w-7xl md:hidden flex-col ${menu ? "flex" : "flex opacity-0"} bg-[#000000de] transition-opacity duration-500`}>
