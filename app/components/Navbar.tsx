...
const Navbar = () => {
    ...
    return (
        <>
            <header className={`w-full transition-colors duration-500 ${scrollHeader ? "fixed z-[9999] bg-white" : "relative z-[9999] md:bg-transparent"} ${menu ? "bg-[#000000f3]" : ""} md:bg-transparent`}>
