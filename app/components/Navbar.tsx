...
const Navbar = () => {
    ...
    return (
        <>
            <header className={`w-full transition-colors duration-500 ${scrollHeader ? "fixed z-[9999] bg-white shadow" : "relative z-[9999] md:bg-transparent"} ${menu ? "bg-[#000000f3] md:bg-transparent" : ""}`}>
                    ...
                    <div className='md:hidden'>
                        <label>
                            <div className="w-9 h-10 cursor-pointer flex flex-col items-center justify-center">
                                ...
                                <div className={`w-[50%] h-[2px] ${scrollHeader?"text-black":"text-white"} rounded-sm transition-all duration-300 origin-left translate-y-[0.45rem] peer-checked:rotate-[-45deg]`} ></div>
                                <div className={`w-[50%] h-[2px] ${scrollHeader?"text-black":"text-white"} rounded-md transition-all duration-300 origin-center peer-checked:hidden ></div>
                                <div className={`w-[50%] h-[2px] ${scrollHeader?"text-black":"text-white"} rounded-md transition-all duration-300 origin-left -translate-y-[0.45rem] peer-checked:rotate-[45deg]" ></div>
                            </div>
                        </label>
                    </div>
                </section>
