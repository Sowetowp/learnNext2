...
const Navbar = () => {
    ...
    return (
        <>
            <header className={`w-full h-fit ${scrollHeader ? "fixed z-[9999] bg-[#000000f3]" : "relative z-[9999]"} ${menu? "bgm-[#000000f3]":""} md:bg-transparent`}>
                ...
                <section className={`w-full m-auto max-w-7xl md:hidden flex-col ${menu ? "flex" : "flex"} bg-[#000000de] transition-transform duration-500`} style={{transform:`translateX(${menu?"0%":"100%"})`}}>
