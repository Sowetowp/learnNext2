    ...
    return (
        <>
            <header className={`w-full ${scrollHeader ? "fixed z-[9999]" : "relative z-[9999]"} ${menu? "bg-[#000000f3]":""} md:bg-transparent`}>
                ...
                <section className={`w-full m-auto max-w-7xl md:hidden flex-col ${menu ? "flex" : "flex"} bg-[#000000de] transition-transform duration-500`} style={{transform:`translateX(100%)"}}>
