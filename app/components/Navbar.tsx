...
const Navbar = () => {
    ...
    return (
        <>
            <header className={`w-full transition-colors duration-500 ${scrollHeader ? "fixed z-[9999] bg-[#000000e0]" : "relative z-[9999]"} ${menu ? "bg-[#000000f3]" : ""} md:bg-transparent`}>
            ...
            <section className={`w-full m-auto max-w-7xl md:hidden flex-col flex bg-[#000000de] transition-transform duration-500 ${scrollHeader ? "fixed top-20" : "relative"} z-[9999]`} style={{ transform: `translateX(${menu ? "0%" : "100%"})` }}>
