    ...
    return (
        <>
            <header className={`w-full ${scrollHeader ? "fixed z-[9999]" : "relative z-[9999]"}`}>
                ...
                <section className={`w-full m-auto max-w-7xl md:hidden flex-col ${menu ? "flex opacity-100" : "flex opacityl-0 -z-0"} relative transition-opacity transi duration-500`}>
