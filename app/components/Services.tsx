    ...
    return (
        <>
            <section className='w-full max-w-7xl m-auto bg-white py-28'>
                ...
                <p className='mt-7 m-auto text-[0.95rem] text-gray-500 w-[80%] md:w-1/2 text-center'>There are many variations of passages of Lorem Ipsum but the majority have suffered in some form.</p>
